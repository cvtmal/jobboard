...
namespace App\Models {
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\JobListingSubscription> $subscriptions
    ...
    /**
     * App\Models\JobListingSubscription
     *
     * @property-read \App\Models\JobListing $jobListing
     * @property-read \App\Models\JobTier $jobTier
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereJobListingId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereJobTierId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription wherePurchasedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereExpiresAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription wherePricePaid($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereDiscountApplied($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription wherePromoCode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription wherePaymentStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription wherePaymentMethod($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereTransactionId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription query()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription select(array|mixed $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription selectSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription selectRaw(string $expression)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription fromSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription fromRaw(string $expression, mixed $bindings)
     * @method static array createSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
     * @method static array parseSub(mixed $query)
     * @method static mixed prependDatabaseNameIfCrossDatabaseQuery(mixed $query)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription addSelect(array|mixed $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription distinct()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription from(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $table, string|null $as)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription useIndex(string $index)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription forceIndex(string $index)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription ignoreIndex(string $index)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription join(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|\Illuminate\Contracts\Database\Query\Expression|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second, string $type, bool $where)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription joinLateral(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription leftJoinLateral(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription rightJoin(\Illuminate\Contracts\Database\Query\Expression|string $table, \Closure|string $first, string|null $operator, \Illuminate\Contracts\Database\Query\Expression|string|null $second)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription crossJoinSub(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|string $query, string $as)
     * @method static \Illuminate\Database\Query\JoinClause newJoinClause(string $type, \Illuminate\Contracts\Database\Query\Expression|string $table)
     * @method static \Illuminate\Database\Query\JoinLateralClause newJoinLateralClause(string $type, \Illuminate\Contracts\Database\Query\Expression|string $table)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription mergeWheres(array $wheres, array $bindings)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription where(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription addArrayOfWheres(array $column, string $boolean, string $method)
     * @method static array prepareValueAndOperator(string $value, string $operator, bool $useDefault)
     * @method static bool invalidOperatorAndValue(string $operator, mixed $value)
     * @method static bool invalidOperator(string $operator)
     * @method static bool isBitwiseOperator(string $operator)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhere(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNot(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNot(\Closure|string|array|\Illuminate\Contracts\Database\Query\Expression $column, mixed $operator, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereColumn(\Illuminate\Contracts\Database\Query\Expression|string|array $first, string|null $operator, string|null $second, string|null $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereColumn(\Illuminate\Contracts\Database\Query\Expression|string|array $first, string|null $operator, string|null $second)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereRaw(string $sql, mixed $bindings, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereRaw(string $sql, mixed $bindings)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNotLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNotLike(\Illuminate\Contracts\Database\Query\Expression|string $column, string $value, bool $caseSensitive)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNotIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNotIn(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $values)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereIntegerInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereIntegerNotInRaw(string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNull(string|array|\Illuminate\Contracts\Database\Query\Expression $columns, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNull(string|array|\Illuminate\Contracts\Database\Query\Expression $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNotNull(string|array|\Illuminate\Contracts\Database\Query\Expression $columns, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereBetween(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereBetween(\Illuminate\Contracts\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNotBetween(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNotBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNotBetween(\Illuminate\Contracts\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNotBetweenColumns(\Illuminate\Contracts\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNotNull(\Illuminate\Contracts\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereDate(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereDate(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereTime(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereTime(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|null $operator, \DateTimeInterface|string|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereDay(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereDay(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereMonth(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereMonth(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereYear(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereYear(\Illuminate\Contracts\Database\Query\Expression|string $column, \DateTimeInterface|string|int|null $operator, \DateTimeInterface|string|int|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription addDateBasedWhere(string $type, \Illuminate\Contracts\Database\Query\Expression|string $column, string $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNested(string $boolean)
     * @method static \Illuminate\Database\Query\Builder forNestedWhere()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription addNestedWhereQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereSub(\Illuminate\Contracts\Database\Query\Expression|string $column, string $operator, \Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNotExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNotExists(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $callback)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription addWhereExistsQuery(string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereRowValues(array $columns, string $operator, array $values, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereRowValues(array $columns, string $operator, array $values)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereJsonContains(string $column, mixed $value, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereJsonContains(string $column, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereJsonDoesntContain(string $column, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereJsonDoesntContain(string $column, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereJsonOverlaps(string $column, mixed $value, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereJsonOverlaps(string $column, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereJsonDoesntOverlap(string $column, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereJsonDoesntOverlap(string $column, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereJsonContainsKey(string $column, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereJsonContainsKey(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereJsonDoesntContainKey(string $column, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereJsonDoesntContainKey(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereJsonLength(string $column, mixed $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereJsonLength(string $column, mixed $operator, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription dynamicWhere(string $method, array $parameters)
     * @method static void addDynamic(string $segment, string $connector, array $parameters, int $index)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereFullText(string|string[] $columns, string $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereFullText(string|string[] $columns, string $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereAll(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereAll(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereAny(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereAny(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNone(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNone(\Illuminate\Contracts\Database\Query\Expression[]|\Closure[]|string[] $columns, mixed $operator, mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription groupBy(array|\Illuminate\Contracts\Database\Query\Expression|string ...$groups)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription groupByRaw(string $sql)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription having(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, \DateTimeInterface|string|int|float|null $operator, \DateTimeInterface|string|int|float|null $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orHaving(\Illuminate\Contracts\Database\Query\Expression|\Closure|string $column, \DateTimeInterface|string|int|float|null $operator, \DateTimeInterface|string|int|float|null $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription havingNested(string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription addNestedHavingQuery(\Illuminate\Database\Query\Builder $query, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription havingNull(array|string $columns, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orHavingNull(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription havingNotNull(array|string $columns, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orHavingNotNull(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription havingBetween(string $column, string $boolean, bool $not)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription havingRaw(string $sql, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orHavingRaw(string $sql)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orderBy(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column, string $direction)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orderByDesc(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription latest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription oldest(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription inRandomOrder(string|int $seed)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orderByRaw(string $sql, array $bindings)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription skip(int $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription offset(int $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription take(int $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription limit(int $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription groupLimit(int $value, string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription forPage(int $page, int $perPage)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription forPageBeforeId(int $perPage, int|null $lastId, string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription forPageAfterId(int $perPage, int|null $lastId, string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription reorder(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Contracts\Database\Query\Expression|string|null $column, string $direction)
     * @method static array removeExistingOrdersFor(string $column)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription union(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $query, bool $all)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription unionAll(\Closure|\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $query)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription lock(string|bool $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription lockForUpdate()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription beforeQuery()
     * @method static void applyBeforeQueryCallbacks()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription afterQuery()
     * @method static mixed applyAfterQueryCallbacks(mixed $result)
     * @method static string toSql()
     * @method static string toRawSql()
     * @method static JobListingSubscription|null find(int|string $id, array|string $columns)
     * @method static mixed findOr(mixed $id, callable|list<string>|string $columns, callable|null $callback)
     * @method static mixed value(string $column)
     * @method static mixed rawValue()
     * @method static mixed soleValue(string $column)
     ...
     * @method static int getCountForPagination(array $columns)
     * @method static array runPaginationCountQuery(array $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription cloneForPaginationCount()
     * @method static array withoutSelectAliases()
     * @method static \Illuminate\Support\LazyCollection<int,\stdClass> cursor()
     * @method static void enforceOrderBy()
     * @method static mixed pluck(\Illuminate\Contracts\Database\Query\Expression|string $column, string|null $key)
     ...
     * @method static mixed aggregate(string $function, array $columns)
     * @method static float|int numericAggregate(string $function, array $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription setAggregate(string $function, array $columns)
     * @method static mixed onceWithColumns(array $columns, callable $callback)
     * @method static bool insert()
     * @method static int insertOrIgnore()
     * @method static int insertGetId(string|null $sequence)
     ...
     * @method static array getBindings()
     * @method static array getRawBindings()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription setBindings(string $type)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription addBinding(mixed $value, string $type)
     * @method static mixed castBinding(mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription mergeBindings()
     * @method static array cleanBindings()
     * @method static mixed flattenValue(mixed $value)
     * @method static string defaultKeyName()
     * @method static \Illuminate\Database\ConnectionInterface getConnection()
     * @method static \Illuminate\Database\Query\Processors\Processor getProcessor()
     * @method static \Illuminate\Database\Query\Grammars\Grammar getGrammar()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription useWritePdo()
     * @method static bool isQueryable(mixed $value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription clone()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription cloneWithout()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription cloneWithoutBindings()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription dump(mixed ...$args)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription dumpRawSql()
     * @method static void dd()
     * @method static void ddRawSql()
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription wherePast(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNowOrPast(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWherePast(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNowOrPast(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereFuture(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereNowOrFuture(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereFuture(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereNowOrFuture(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription wherePastOrFuture(array|string $columns, string $operator, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereToday(array|string $columns, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereBeforeToday(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereTodayOrBefore(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereAfterToday(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereTodayOrAfter(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereToday(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereBeforeToday(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereTodayOrBefore(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereAfterToday(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription orWhereTodayOrAfter(array|string $columns)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription whereTodayBeforeOrAfter(array|string $columns, string $operator, string $boolean)
     * @method static bool chunk(int $count, callable $callback)
     * @method static mixed chunkMap(callable $callback, int $count)
     * @method static bool each(callable $callback, int $count)
     * @method static bool chunkById(int $count, callable $callback, string|null $column, string|null $alias)
     ...
     * @method static mixed lazyByIdDesc(int $chunkSize, string|null $column, string|null $alias)
     * @method static \Illuminate\Support\LazyCollection orderedLazyById(int $chunkSize, string|null $column, string|null $alias, bool $descending)
     * @method static JobListingSubscription|null first(array|string $columns)
     * @method static JobListingSubscription firstOrFail(array|string $columns, string|null $message)
     * @method static JobListingSubscription sole(array|string $columns)
     * @method static \Illuminate\Contracts\Pagination\CursorPaginator paginateUsingCursor(int $perPage, array|string $columns, string $cursorName, \Illuminate\Pagination\Cursor|string|null $cursor)
     * @method static string getOriginalColumnNameForCursorPagination(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed> $builder, string $parameter)
     * @method static \Illuminate\Pagination\LengthAwarePaginator paginator(\Illuminate\Support\Collection $items, int $total, int $perPage, int $currentPage, array $options)
     * @method static \Illuminate\Pagination\Paginator simplePaginator(\Illuminate\Support\Collection $items, int $perPage, int $currentPage, array $options)
     * @method static \Illuminate\Pagination\CursorPaginator cursorPaginator(\Illuminate\Support\Collection $items, int $perPage, \Illuminate\Pagination\Cursor $cursor, array $options)
     * @method static \Illuminate\Database\Eloquent\Builder<JobListingSubscription>|JobListingSubscription tap(callable $callback)
     * @method static mixed when(callable|\TWhenParameter|null $value, callable|null $callback, callable|null $default)
     * @method static mixed unless(callable|\TUnlessParameter|null $value, callable|null $callback, callable|null $default)
     * @method static \Illuminate\Support\Collection explain()
     * @method static mixed forwardCallTo(mixed $object, string $method, array $parameters)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class JobListingSubscription extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
