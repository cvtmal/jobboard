...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.applicant.driver' => 'string',
            'auth.guards.applicant.provider' => 'string',
            ...
            'auth.providers.applicants.driver' => 'string',
            'auth.providers.applicants.model' => 'string',
            ...
            'auth.passwords.applicants.provider' => 'string',
            'auth.passwords.applicants.table' => 'string',
            'auth.passwords.applicants.expire' => 'integer',
            'auth.passwords.applicants.throttle' => 'integer',
            ...
            'filesystems.links./Users/damianermanni/Herd/jobboard/public/storage' => 'string',
...
'auth.guards.applicant.driver','auth.guards.applicant.provider','auth.guards.company.driver','auth.guards.company.provider','auth.guards.admin.driver',
'auth.guards.admin.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.applicants.driver','auth.providers.applicants.model',
'auth.providers.companies.driver','auth.providers.companies.model','auth.providers.admins.driver','auth.providers.admins.model','auth.passwords.users.provider',
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.applicants.provider','auth.passwords.applicants.table',
'auth.passwords.applicants.expire','auth.passwords.applicants.throttle','auth.passwords.companies.provider','auth.passwords.companies.table','auth.passwords.companies.expire',
'auth.passwords.companies.throttle','auth.passwords.admins.provider','auth.passwords.admins.table','auth.passwords.admins.expire','auth.passwords.admins.throttle',
...
'filesystems.disks.s3.report','filesystems.links./Users/damianermanni/Herd/jobboard/public/storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','tinker.commands','tinker.alias',
'tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api',);
        registerArgumentsSet('routes', 'home','dashboard','company.dashboard',
...
'company.register','company.login','company.password.request',
'company.password.email','company.password.reset','company.password.store','company.logout','company.verification.notice',
'company.verification.verify','company.verification.send','company.settings.profile','company.profile.update',
'company.profile.destroy','company.settings.password','company.password.update','company.settings.appearance','storage.local',);
