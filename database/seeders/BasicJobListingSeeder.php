...
final class BasicJobListingSeeder extends Seeder
{
    ...
    private function createZurichJobs(array $jobTitles, $companies): void
    {
        foreach (range(1, 5) as $i) {
            $job = new JobListing([
                ...
                'active_from' => CarbonImmutable::now()->subDays(random_int(1, 30)),
                'active_until' => CarbonImmutable::now()->addDays(random_int(30, 90)),
    ...
    private function createMultiLocationJobs(array $jobTitles, $companies): void
    {
        foreach (range(1, 3) as $i) {
            ...
            foreach (array_slice($additionalLocations, 0, random_int(1, 2)) as [$city, $canton]) {
