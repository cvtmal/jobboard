...
composer run dev  # Starts Laravel server, queue worker, logs, and Vite dev server concurrently
...
herd coverage ./vendor/bin/pest --coverage        # Run tests with type coverage (min 100%)
```
