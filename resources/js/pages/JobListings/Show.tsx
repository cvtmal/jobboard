          ...
          <div className="lg:col-span-2 space-y-6">
            <Card>
              <CardHeader className="pb-3 flex flex-row justify-between items-start">
                ...
                <Badge className={
                  jobListing.status === 'published' ? 'bg-green-100 text-green-800' :
                  jobListing.status === 'draft' ? 'bg-yellow-100 text-yellow-800' :
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {jobListing.created_at ? new Date(jobListing.created_at).toLocaleDateString() : 'N/A'}
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                {(jobListing.company.address || jobListing.company.city) && (
                  <div>
                    ...
                    <p className="mt-1">
                      {[
                        jobListing.company.address,
                        jobListing.company.postcode,
            ...
            <Card className="bg-red-50">
              <CardContent className="pt-6">
                <p className="text-sm text-gray-700 mb-4">Danger Zone</p>
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button variant="destructive" className="w-full">Delete Job Listing</Button>
                  </AlertDialogTrigger>
                  <AlertDialogContent>
                    <AlertDialogHeader>
