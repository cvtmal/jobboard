...
import { Eye, ImageIcon, LucideYoutube, Plus, Trash2, Upload, Video, Youtube, YoutubeIcon } from 'lucide-react';
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Customize your company's career page</p>
                        </div>
