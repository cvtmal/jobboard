            ...
            <div className="py-8">
                <div className="mx-auto max-w-5xl">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground mt-2">Update the details of your job listing.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Update the general information about this position</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                        ...
                                        <Select value={data.workplace} onValueChange={(value) => setData('workplace', value)}>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Update where the job will be performed</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <Input id="city" value={data.city} onChange={(e) => setData('city', e.target.value)} className="mt-1.5" />
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Update salary information for this position</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                        <Label htmlFor="salary_type">Salary Type</Label>
                                        <Select value={data.salary_type} onValueChange={(value) => setData('salary_type', value)}>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Update how candidates can apply for this position</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div>
                                    <Label htmlFor="application_process">Application Process</Label>
                                    <Select value={data.application_process} onValueChange={(value) => setData('application_process', value)}>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Update the status of this job listing</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div>
