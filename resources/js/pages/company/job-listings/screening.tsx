...
import { Calendar, CheckSquare, Circle, Hash, Minus, Paperclip, Plus, ToggleLeft, Trash2 } from 'lucide-react';
...
export default function Screening({ jobListing, auth }: Props) {
    ...
    const predefinedQuestions: PredefinedQuestion[] = [
        { id: 'start-date', label: 'Start date', answerType: 'date' as const, defaultText: 'When are you available to start working with us?' },
        {
            ...
            defaultText: 'What is your expected yearly compensation in CHF?',
        },
        {
            id: 'work-auth',
            label: 'Work authorization',
            answerType: 'yes/no' as const,
            defaultText: 'Are you currently legally permitted to work in Switzerland?',
        },
        ...
        { id: 'drivers-license', label: "Driver's license", answerType: 'yes/no' as const, defaultText: "Do you have a valid driver's license?" },
        {
            ...
            label: 'Visa status',
            answerType: 'yes/no' as const,
            defaultText: 'Will you now or in the future require sponsorship for employment visa status?',
        },
        ...
        },
        {
            ...
            choices: ['Full-time', 'Part-time', 'Both'],
        },
    ...
    const getAnswerTypeIcon = (type: Question['answerType']) => {
        switch (type) {
            case 'short-text':
                return <Minus className="text-primary mr-2 h-4 w-4" />;
            case 'yes/no':
                return <ToggleLeft className="text-primary mr-2 h-4 w-4" />;
            case 'single-choice':
                return <Circle className="text-primary mr-2 h-4 w-4" />;
            case 'multiple-choice':
                return <CheckSquare className="text-primary mr-2 h-4 w-4" />;
            case 'date':
                return <Calendar className="text-primary mr-2 h-4 w-4" />;
            case 'number':
                return <Hash className="text-primary mr-2 h-4 w-4" />;
            case 'file-upload':
                return <Paperclip className="text-primary mr-2 h-4 w-4" />;
            default:
                return null;
        }
    };
                ...
                <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                    <form onSubmit={handleSubmit}>
                        <div className="mb-8">
                            ...
                            <p className="text-muted-foreground mt-2">Customize the document requirements for this job.</p>
                        </div>
                                                    ...
                                                    <SelectContent>
                                                        <SelectItem value="optional">
                                                            <div className="flex flex-col">
                                                                ...
                                                                <span className="text-muted-foreground text-xs">
                                                                    {requirementOptions.optional.description}
                                                                </span>
                                                            </div>
                                                        </SelectItem>
                                                        <SelectItem value="required">
                                                            <div className="flex flex-col">
                                                                ...
                                                                <span className="text-muted-foreground text-xs">
                                                                    {requirementOptions.required.description}
                                                                </span>
                                                            </div>
                                                        </SelectItem>
                                                        <SelectItem value="knockout">
                                                            <div className="flex flex-col">
                                                                ...
                                                                <span className="text-muted-foreground text-xs">
                                                                    {requirementOptions.knockout.description}
                                                                </span>
                                                            </div>
                                                        </SelectItem>
                                                    </SelectContent>
                                        ...
                                        <CardContent className="p-4">
                                                    ...
                                                    >
                                                        ...
                                                        <SelectContent>
                                                            <SelectItem value="short-text">
                                                                <div className="flex items-center">
                                                                    <Minus className="text-primary mr-2 h-4 w-4" />
                                                                    <span>Short text</span>
                                                                </div>
                                                            </SelectItem>
                                                            <SelectItem value="yes/no">
                                                                <div className="flex items-center">
                                                                    <ToggleLeft className="text-primary mr-2 h-4 w-4" />
                                                                    <span>Yes / No</span>
                                                                </div>
                                                            </SelectItem>
                                                            <SelectItem value="single-choice">
                                                                <div className="flex items-center">
                                                                    <Circle className="text-primary mr-2 h-4 w-4" />
                                                            ...
                                                            <SelectItem value="file-upload">
                                                                <div className="flex items-center">
                                                                    <Paperclip className="text-primary mr-2 h-4 w-4" />
                                            ...
                                            {question.answerType === 'single-choice' && question.choices && question.choices.length > 0 && (
                                                <div className="mt-4 space-y-4">
                                                    <Label>Options</Label>
                                                    <RadioGroup value={question.choices[0]} onValueChange={() => {}}>
                            ...
                            <CardContent className="space-y-4">
                                    ...
                                    {predefinedQuestions
                                        ...
                                        .map((question) => (
                                            <button
                                                ...
                                                className={`bg-background hover:bg-primary hover:text-primary-foreground inline-flex cursor-pointer items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors ${
                                                    isDarkMode ? 'border-border' : 'border-input'
                                                }`}
                                            >
                                                {question.label}
                                            </button>
                                ...
                                <div className="flex items-center gap-2">
                                    <Input
                                        ...
                                        className="flex-1"
                                    />
                                    <Button type="button" onClick={addCustomQuestion} disabled={!customQuestion.trim()} size="sm">
