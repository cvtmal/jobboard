                        ...
                        <div className="space-y-6 lg:col-span-2">
                            ...
                            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                    <div>
                                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{jobListing.title}</h1>
                            ...
                            <Card className="border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
                                ...
                                <CardContent>
                                    <div>{formatApplicationMethod()}</div>
                                </CardContent>
                                    ...
                                    <div className="flex items-center">
                                        {jobListing.company.logo ? (
                                            <img
                                                ...
                                                className="h-16 w-16 rounded-lg border border-gray-200 object-contain dark:border-gray-800"
                                            />
                                        ) : (
