    ...
    return (
        <div className={isDarkMode ? 'dark' : ''}>
            <div className={`relative min-h-screen antialiased ${isDarkMode ? 'bg-gray-950 text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
                ...
                <div className="fixed inset-0 bg-gradient-to-b from-transparent to-black opacity-5 dark:opacity-20 pointer-events-none" />
                <div className="fixed inset-0 bg-grid-white/[0.03] bg-grid-12/12 dark:bg-grid-white/[0.03] pointer-events-none" />
                ...
                <div className="relative max-w-7xl mx-auto">
                    <header className="pt-8 pb-6 px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                {/* Auth links */}
                                {auth.user ? (
                                    <a href="/dashboard" className="inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                        Dashboard
                                    </a>
                                ) : (
                                    <div className="flex items-center gap-2">
                                        <a href="/login" className="inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-indigo-600 bg-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-white dark:ring-gray-700 dark:hover:bg-gray-700">
                                            Sign in
                                        </a>
                                        <a href="/register" className="inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                            Sign up
                                        </a>
                                    </div>
                                )}
                    ...
                    <main className="px-4 sm:px-6 lg:px-8 pb-12">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                            {/* Filters sidebar */}
                            <div className="lg:col-span-1 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm">
                                ...
                                <div className="space-y-4">
                                    {filteredJobs.length > 0 ? (
                                        filteredJobs.map((job) => (
                                            <div
                                                key={job.id}
                                                className="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm hover:shadow-md transition-shadow"
                                            >
                                                ...
                                                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                    ...
                                                    {(job.city || job.primary_canton_code) && (
                                                        <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mr-1 text-gray-400 dark:text-gray-500">
                                                ...
                                                <div className="mt-4 flex justify-end">
                                                    <a
                                                        href={`/jobs/${job.id}`}
                                                        className="inline-flex items-center rounded-md bg-indigo-50 dark:bg-indigo-900/30 px-3 py-2 text-sm font-medium text-indigo-700 dark:text-indigo-300 hover:bg-indigo-100 dark:hover:bg-indigo-900/50"
                                                    >
                                                        Mehr erfahren
                                        ...
                                        <div className="text-center py-12">
                                            ...
                                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Probiere andere Filterkriterien oder schau später wieder vorbei.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
